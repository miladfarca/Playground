/* This file was generated by encoder.py as part of lass - the lightweight
assembler (C) 2016 Michael Lazear*/
#ifndef __LASS_ISA__
#define __LASS_ISA__
...
#define MODRM(mod, reg, rm)                                                    \
  (((mod & 0x3) << 6) | ((reg & 0x7) << 3) | (rm & 0x7))
#define COMBINE(o, m) ((o << 8) | m)
#define ishex(c) (((tolower(c)) <= 'f') & ((tolower(c)) >= '0'))
#define ENDIAN(x)                                                              \
  (((x & 0xFF) << 24) | ((x & 0x0000FF00) << 8) | ((x & 0x00FF0000) >> 8) |    \
   ((x & 0xFF000000) >> 24))
...
isa x86[] = {
    ...
    {"idiv", r32, none, 0xf7, 0x7, 0x0, 0x0},
